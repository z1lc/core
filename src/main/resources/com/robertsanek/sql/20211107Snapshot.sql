-- Queries used in The Snapshot #8 / November 2021
...
from hm
where date_of_sleep >= '2021-08-22'
  and date_of_sleep < '2021-11-07')
...
where read_at >= '2021-08-22'
  and read_at < '2021-11-07';
...
where created_at >= '2021-08-22'
  and created_at < '2021-11-07';
