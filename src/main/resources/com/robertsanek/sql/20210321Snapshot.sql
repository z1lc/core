...
from hm
where date_of_sleep >= '2021-01-03'
  and date_of_sleep < '2021-03-21';

-- Books
select title, author_name
from goodreads_books
where read_at >= '2021-01-03'
  and read_at < '2021-03-21';
...
where created_at >= '2021-01-03'
  and created_at < '2021-03-21';
