-- Queries used in The Snapshot #9 / April 2022
-- https://docs.google.com/document/d/1-x8dtw5qWq7cDSMnkAo3Aiw4J4YjbbEvuMwt0zBN5Pc/edit#heading=h.c5bg5bae2yks
...
select sum(case when active_zone_minutes > 10 then 1 else 0 end)::float /
       (13 * 7)                     as percent_days_with_exercise,
...
from hm
where date_of_sleep >= '2022-01-01'
  and date_of_sleep < '2022-04-03')
...
where read_at >= '2022-01-01'
  and read_at < '2022-04-03';

-- Anki
select sum(total_minutes) / (13 * 7)                                         as avg_minutes,
       sum(case when total_minutes >= 14.5 then 1.0 else 0.0 end) / (13 * 7) as percent
from rlp_daily_education
where created_at >= '2022-01-01'
  and created_at < '2022-04-03';
